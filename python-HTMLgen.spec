...
%description -l pl 
HTMLGen jest modu³em do tworzenia dokumentów w HTML'u za pomoc± skryptów w
...
znajduj±cych sie w okreslonym katalogu, tak aby mo¿na je by³o ³atwo ogl±daæ
przez WWW. Python jest dobrym jêzykiem do programowania takich zadañ, a
wykorzystanie biblioteki HTMLGen znacznie u³atwia konstruowanie obiektów,
które po przetworzeniu przez tê bibliotekê utworz± spójn± stronê WWW.
